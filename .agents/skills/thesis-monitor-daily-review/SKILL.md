...
- Treat `ohlcv-structure-v1` as the sole source for dynamic zones, boxes, Major Swings, tentative Elliott, Fibonacci, chart invalidation, risk/reward, and chart state. Local Pivot zones are not Major Swing anchors. Low-confidence Elliott is not a core conclusion.
