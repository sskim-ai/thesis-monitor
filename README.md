...
- [Selective cash-flow user-visible integration](docs/architecture/CASH_FLOW_USER_VISIBLE_INTEGRATION.md)
- [Working-capital shadow consumption](docs/architecture/WORKING_CAPITAL_SHADOW_CONSUMPTION.md)
- [Working-capital runtime shadow canary](docs/architecture/WORKING_CAPITAL_RUNTIME_SHADOW_CANARY.md)
- [Working-capital user-visible pre-integration](docs/architecture/WORKING_CAPITAL_USER_VISIBLE_PREINTEGRATION.md)
- [Industry-specific reasoning](docs/architecture/INDUSTRY_SPECIFIC_REASONING.md)
- [Price Structure Wave Fibonacci v3](docs/architecture/PRICE_STRUCTURE_WAVE_FIB_V3.md)
- [OHLCV long-history contract](docs/architecture/OHLCV_LONG_HISTORY_CONTRACT.md)
- [Primary monthly wave hypothesis](docs/architecture/PRIMARY_MONTHLY_WAVE_HYPOTHESIS.md)
- [Wave Fibonacci source provenance](docs/architecture/WAVE_FIBONACCI_SOURCE_PROVENANCE.md)
- [Multi-timeframe SR confluence v3](docs/architecture/MULTI_TIMEFRAME_SR_CONFLUENCE_V3.md)
- [Technical-zone evidence families](docs/architecture/TECHNICAL_ZONE_EVIDENCE_FAMILIES.md)
- [Price Structure v3 shadow policy](docs/architecture/PRICE_STRUCTURE_V3_SHADOW_POLICY.md)
...
insufficient. Korean investor flow uses only the latest valid daily bar, including distinct 1-day,
5-day, and 20-day individual, institution, and foreign net buying plus the provider's supply summary.
