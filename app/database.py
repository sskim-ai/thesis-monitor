...
def _ensure_sqlite_columns() -> None:
    ...
    table_columns = {
        "watchlistitem": {
            ...
            "onboarding_initial_evidence": "TEXT DEFAULT '{}'",
            "onboarding_evidence_fingerprint": "VARCHAR",
            "onboarding_decision_readiness": "TEXT DEFAULT '{}'",
            "onboarding_retry_class": "VARCHAR DEFAULT 'NONE'",
            "onboarding_attempt_count": "INTEGER DEFAULT 0",
            "onboarding_last_attempt_at": "DATETIME",
            "onboarding_next_retry_at": "DATETIME",
            "onboarding_last_error": "VARCHAR",
            "onboarding_last_attempt_origin": "VARCHAR",
            "onboarding_market_packet_cutoff": "DATETIME",
