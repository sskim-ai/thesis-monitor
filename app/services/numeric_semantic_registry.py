...
NUMERIC_SEMANTICS = {
    ...
    "peer_pe_relative_multiple": _spec(
        "peer_pe_relative_multiple",
        ("x",),
        ("peer PER 상대배수", "비교군 PER 상대배수"),
        (r"(?:peer|동종업계|비교군).*per.*상대.*배수",),
        "multiple",
    ),
    "peer_pb_relative_multiple": _spec(
        "peer_pb_relative_multiple",
        ("x",),
        ("peer PBR 상대배수", "비교군 PBR 상대배수"),
        (r"(?:peer|동종업계|비교군).*pbr.*상대.*배수",),
        "multiple",
    ),
    "peer_pe_cross_section_percentile": _spec(
        "peer_pe_cross_section_percentile",
        ("pct",),
        ("peer PER 횡단면 백분위", "비교군 PER 백분위"),
        (r"(?:peer|동종업계|비교군).*per.*백분위",),
        "percentage",
    ),
    "peer_pb_cross_section_percentile": _spec(
        "peer_pb_cross_section_percentile",
        ("pct",),
        ("peer PBR 횡단면 백분위", "비교군 PBR 백분위"),
        (r"(?:peer|동종업계|비교군).*pbr.*백분위",),
        "percentage",
    ),
    "audit_count": _spec(
        "audit_count",
...
_FIELD_RULES = (
    ...
    NumericFieldRule(
        ("peer_valuation",),
        r"fields\.company_pe_relative_multiple",
        "peer_pe_relative_multiple",
        "x",
    ),
    NumericFieldRule(
        ("peer_valuation",),
        r"fields\.company_pb_relative_multiple",
        "peer_pb_relative_multiple",
        "x",
    ),
    NumericFieldRule(
        ("peer_valuation",),
        r"fields\.company_pe_cross_section_percentile",
        "peer_pe_cross_section_percentile",
        "pct",
    ),
    NumericFieldRule(
        ("peer_valuation",),
        r"fields\.company_pb_cross_section_percentile",
        "peer_pb_cross_section_percentile",
        "pct",
    ),
    NumericFieldRule(
