...
|---|---|---|---|---|---|
| `main` / operating | implementation `c5f1fbc...` plus final persistent state | shared KR/US major-S/R observed-price reality gate; natural proof pending | no KRX/peer experimental dependency | current baseline | wait for natural stock-message proof |
