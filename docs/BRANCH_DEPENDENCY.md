...
|---|---|---|---|---|---|
| `main` / operating | runtime baseline `026df71...`; final docs SHA resolves from Git | provisional Bollinger/price-label runtime plus run-44 validator convergence controls; natural proof pending | no KRX/peer experimental dependency | current baseline after promotion | wait for natural US and next normal KR close proof |
