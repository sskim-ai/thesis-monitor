...
|---|---|---|---|---|---|
| `main` / operating | implementation `5358556...` plus final persistent state | US macro neutral omission and exact received-payload quality gate; natural proof pending | no KRX/peer experimental dependency | current baseline | wait for natural US morning proof |
