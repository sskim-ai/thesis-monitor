...
backend/internal 가격 구조 계산은 실제 자료가 확보되는 범위에서 일봉 1200, 주봉 600, 월봉 300을 기본 이력으로 사용하고 다음을 본다. Public Action snapshot은 판단에 필요한 압축 지표만 제공하며 이 내부 이력이나 raw OHLCV를 노출하지 않는다.
