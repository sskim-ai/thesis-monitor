# 2026-08-22 US Natural Sent Message Bundle

- Packet: `2026-08-22-us-run-32-dde10ec6c9eb`
- Delivery mode: `deterministic_fallback`
- Sent: `14/14` at `2026-08-22 08:40:04.711679 KST`
- Source: immutable `fallback-messages.json`, SHA-256 `c40b7b2f11432e224f33dc862742ae409aa76456b9a019bd84d3271f31ce52cf`
- Order: actual dispatcher order, market digest first and then stock deliveries by creation time/delivery ID.

The contents inside each text fence are exact sent text.

## 1. Market digest, delivery 236
...
📐 Valuation
PER: N/M
PBR = 현재가 ÷ BVPS = $80.86 ÷ $12.26 = 6.6배
fPER = 현재가 ÷ 시장 예상 EPS = $80.86 ÷ $0.59 = 137.1배
과거 대비:
...
보유자:
• 차트 무효화 가격: $224.56
• 동적 지지 유지 여부: $228.60~$235.66
가격 규칙 이력:
• 등록 확인선 $250은 아직 도달하지 않았습니다.

📐 Valuation
PER = 현재가 ÷ TTM EPS = $235.68 ÷ $16.56 = 14.2배
PBR = 현재가 ÷ BVPS = $235.68 ÷ $36.14 = 6.5배
fPER: 17.4배
fPBR = 현재가 ÷ 내부 FY1 추정 BVPS = $235.68 ÷ $34.28 = 6.9배
※ 내부 모델 추정치이며 시장 컨센서스가 아닙니다.
과거 대비:
PER 중앙값 15.3배 · 43백분위 · PBR 중앙값 6.5배 · 52백분위
현재 Valuation: 중립 범위
해석: 현재 배수를 그 시점에 공개된 재무정보로 재구성한 역사적 분포와 비교했습니다.
...
💰 가격
현재가: $1,596.08 · 2026-08-21 미국장 종가
현재 구조: 가격 구조상 추가 확인 대기
신규 관찰자:
...
📐 Valuation
PBR = 현재가 ÷ BVPS = $1,596.08 ÷ $107.78 = 14.8배
과거 대비:
PER 중앙값 19.9배 · PBR 중앙값 9.7배 · 67백분위
현재 Valuation: 판단 자료 부족
오늘 Valuation 변화: 판단 자료 부족
검증된 현재 PBR과 과거 장부가 배수 분포를 함께 확인하며, 이익 기반 배수는 사용하지 않습니다.
...
보유자:
• 차트 무효화 가격: $353.11
• 동적 지지 유지 여부: $360.04~$372.58
가격 규칙 이력:
• 기존 $342 확인선은 이미 돌파한 상태입니다.

📐 Valuation
PER = 현재가 ÷ TTM EPS = $362.86 ÷ $1.92 = 189.0배
PBR = 현재가 ÷ BVPS = $362.86 ÷ $21.99 = 16.5배
과거 대비:
PER 중앙값 68.3배 · 98백분위 · PBR 중앙값 16.5배 · 50백분위
현재 Valuation: 판단 자료 부족
오늘 Valuation 변화: 판단 자료 부족
검증된 현재 PER/PBR과 과거 배수 분포를 함께 확인합니다.
