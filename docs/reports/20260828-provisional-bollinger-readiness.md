# Provisional Bollinger Readiness
...
- `provisional_layer_bypass_total` = `0`
...
```json
{
  "authority_leaks": 0,
  "kr": 7,
  "max_price_structure_lines": 8,
  "metadata_errors": 0,
  "price_lines": 20,
  "provisional_overlap_annotation": 2,
  "provisional_standalone": 17,
  "provisional_suppressed": 1,
  "render_errors": 0,
  "universe": 20,
  "us": 13
}
