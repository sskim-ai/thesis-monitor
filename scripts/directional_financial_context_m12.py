...
from app.services.directional_financial_context_service import (
    ...
    validate_qtd_ytd_conflict_semantics,  # noqa: F401 - historical module API
...
def _case_semantic_errors(
    ...
    *,
    ...
    """Retired compatibility hook; canonical services own hard semantics.

    Historical callers may still inspect this function, but it no longer makes
    ticker-specific financial validity decisions.
    """

    del ticker, candidate, selected_financial_refs
    return ()
...
def _audit_core_batch(
    ...
    *,
    ...
    for candidate in batch.candidates:
        ...
        canonical_semantics = audit_owned_directional_core_semantics(
            candidate,
            owned=owned[ticker],
            catalog=catalogs[ticker],
        ...
        semantic = canonical_semantics.financial_semantics
        qtd_ytd = canonical_semantics.qtd_ytd_semantics
        ...
        errors = tuple(
            dict.fromkeys(
                (
                    *ownership.errors,
                    *canonical_semantics.hard_errors,
                    *case_errors,
        ...
        totals.update(
            {
                ...
                "configured_signal_count": semantic.configured_signal_count,
                "configured_only_current_driver_violation_count": (
                    semantic.configured_only_current_driver_violation_count
                ),
                "configured_signal_false_fulfillment_count": (
                    semantic.configured_signal_false_fulfillment_count
                ),
        ...
        rows.append(
            {
                ...
                "canonical_semantic_audit": canonical_semantics.model_dump(
                    mode="json"
                ),
