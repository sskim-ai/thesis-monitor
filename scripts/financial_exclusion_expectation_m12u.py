...
def scope_audit():
    ...
    allowed = {
        ...
        # M12AN owns the PPE-proxy model projection and its direct regressions.
        ...
        # M12BN changes only disabled-by-default persistence boundaries.
        "app/config.py",
        "app/schemas/thesis.py",
        "app/services/monitoring_service.py",
        # M12BP changes only the approved KR-financial cold-start projection surfaces.
