...
def test_temp_local_future_clause_is_not_tainted_by_prior_current_clause() -> None:
    configured = _configured_ref()
    candidate = {
        "risk_context": {
    ...
    assert _role(candidate, (configured,)) == FinancialClaimRole.PROSPECTIVE_RISK_SCENARIO
