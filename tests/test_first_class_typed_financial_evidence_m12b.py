...
def test_old_and_corrected_financial_grounding_regressions_are_preserved() -> None:
    ...
    assert {
        "material_financial_anchor_grounding_failure",
        "working_capital_grounding_failure",
...
def test_frozen_semantic_surfaces_remain_unchanged() -> None:
    ...
    # Historical changes plus M12AG ownership and M12BP source-sufficiency changes.
    assert all(
        row["status"] == "PASS"
    ...
    assert frozen["source_sufficiency"] == {
        "path": "app/services/coldstart_fundamental_enrichment_service.py",
        "before_sha256": "43a2873b44f83cf0b17dbfa78c6d26f6a0da712e9127bf67f09a44fe5cd090da",
        "after_sha256": "a3fe1d5d2524097d7e5312048fb6de9c7a237cb13a8886953a14bf65f883807e",
        "changed": True,
        "status": "FAIL",
    }
