...
def test_frozen_prompt_schema_and_service_hashes_reproduce() -> None:
    current = m12af._architecture_hashes()
    expected = {
        "monolithic_prompt_sha256": m12af.EXPECTED_CONTROL_PROMPT_SHA256,
        "monolithic_schema_sha256": m12af.EXPECTED_CONTROL_SCHEMA_SHA256,
        "monolithic_control_code_sha256": m12af.EXPECTED_CONTROL_CODE_SHA256,
        "two_stage_service_sha256": m12af.EXPECTED_TWO_STAGE_SERVICE_SHA256,
        "stage1_prompt_sha256": m12af.EXPECTED_STAGE1_PROMPT_SHA256,
        "stage1_schema_sha256": m12af.EXPECTED_STAGE1_SCHEMA_SHA256,
        "stage2_prompt_sha256": m12af.EXPECTED_STAGE2_PROMPT_SHA256,
        "stage2_schema_sha256": m12af.EXPECTED_STAGE2_SCHEMA_SHA256,
    }

    assert not m12af._architecture_hashes_match(current)
    assert {key for key in current if current[key] != expected[key]} == {
        "monolithic_control_code_sha256",
        "monolithic_prompt_sha256",
