...
def test_authoritative_filing_discovery_prefers_latest_period_over_old_correction() -> None:
    rows = [
        {
            "corp_name": "Generic",
            "report_nm": "[기재정정]사업보고서 (2025.12)",
            "rcept_no": "20260814004019",
            "rcept_dt": "20260814",
        },
        {
            "corp_name": "Generic",
            "report_nm": "반기보고서 (2026.06)",
            "rcept_no": "20260814003800",
            "rcept_dt": "20260814",
        },
    ]
    ...
    assert selected[0].receipt_no == "20260814003800"
    assert selected[0].business_year == 2026
    assert selected[0].report_code == "11012"
